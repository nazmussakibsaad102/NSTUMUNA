			...
			<div class="row">
				<div class="col-md-12 sol-sm-12">
					<div style="text-align:center">
						<p><h3 class="section-title justtitle">Mission and Vision</h3></p>
						
						<p class="lead bottom0 wow bounceInUp">
							1.	To build an MUN community in NSTU.
						</p>
						
						<p class="lead bottom0 wow bounceInUp">
							2.	To spread MUN in NSTU.</p>
						<p class="lead bottom0 wow bounceInUp">
							3.	To make the students of this university advance and able to cope with the current world.</p>
						<p class="lead bottom0 wow bounceInUp">
							4.	To make student aware of International Relations and Politics and to develop the knowledge regarding the current world.
						</p>
						<p class="lead bottom0 wow bounceInUp">
							5.	To spread the name of NSTU all over the country as well as the World.
						</p>
						<p class="lead bottom0 wow bounceInUp">
							6.	To arrange International MUN Conferences every year.
						</p>
						<p class="lead bottom0 wow bounceInUp">
							7.	To make NSTU glorified.
						</p>
					</div>
				</div>
			</div>
